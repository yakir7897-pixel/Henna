...
function FlipDigit({ value }: { value: string }) {
  ...
  return (
    <div className="relative h-11 w-[26px] select-none text-lg font-bold text-white [perspective:220px] sm:h-16 sm:w-11 sm:text-2xl">
...
export function CountdownTimer({ eventDate }: { eventDate: string }) {
  ...
  return (
    <div dir="ltr" className="flex items-start justify-center gap-1.5 py-2 sm:gap-3">
